...
namespace Repository {
    ...
    export const findAdvertById = async (
        ...
        try {
            ...
            console.error('failed to get advert by id', err)
            return Result.err('ERR_UNEXPECTED')
        }
    ...
    export const updateAdvertById = async (
        ...
        try{
           const query = db
            ...
            console.error('failde to update advert by id:', id, err)
            return Result.err('ERR_UNEXPECTED')
        }
    }
    ...
    export const deleteAdvertById = async(
        ...
        try{
            ...
            console.log('failed to delete the specified advert', id, err)
            return Result.err('ERR_UNEXPECTED')
        }
    }
    ...
    export const listAdverts = async (
        ...
        try{
            ...
            console.error('failed to list adverts:', err)
            return Result.err('ERR_UNEXPECTED')
        }
    }
}
